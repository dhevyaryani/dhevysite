export const lang = {
  id: {
    ...
    LAYOUT: {
      NOTICE_TEXT: 'Tanya saya kalau ada pertanyaan',
      PAY_BUTTON: 'Kopi',
      NOTICE_BUTTON: 'Kontak',
      COMMENT_TITLE: 'Komen'
    },
    SEARCH: {
      ONLY_SEARCH: 'Hanya search tags',
      PLACEHOLDER: 'Cari Postingan',
      NOT_FOUND: 'Postingan tidak ketemu'
    },
    HERO: {
      HOME: {
        CONTACT_BUTTON: 'Kontak',
        CONTACT_BUTTON_DES: 'Satu Klik',
        RSS_BUTTON: 'RSS'
      },
      NEWSLETTER: {
